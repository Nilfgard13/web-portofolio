        ...
        <div class="container">
            <div class="flex flex-wrap">
                <div class="w-full px-4 mb-10 lg:w-1/2">
                    ...
                    <h2 class="font-bold text-dark-900 text-3xl mb-5 max-w-md lg:text-4xl">Lorem ipsum dolor sit, amet consectetur
                        adipisicing elit.</h2>
                    <p class="font-medium text-base text-slate-500 max-w-xl lg:text-lg">Lorem ipsum dolor sit amet consectetur,
                        adipisicing elit. Nihil, delectus? Praesentium dolorum
                        deleniti ipsa! Totam, eius!</p>
                </div>
                ...
                <div class="flex items-center px-4 lg:w-1/2">
                    {{-- Youtube --}}
